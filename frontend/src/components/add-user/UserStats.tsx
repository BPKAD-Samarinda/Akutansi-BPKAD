      ...
      {cards.map((card) => {
        ...
        return (
          ...
          >
            ...
            <span className="absolute left-[35%] top-2 h-10 w-10 rounded-full bg-white/10 animate-float-subtle" />
            <span className="absolute right-[25%] bottom-2 h-14 w-14 rounded-full bg-white/5 animate-float-subtle-reverse" />
