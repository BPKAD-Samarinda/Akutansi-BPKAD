  ...
  return (
    <>
      <div className="flex flex-col gap-3 w-full md:flex-row md:items-center md:justify-between">
        {/* Search Bar */}
        <div className="flex items-center bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl px-4 h-11 focus-within:border-teal-400 transition w-full md:w-127">
        ...
        {/* Filters and Refresh Button shifted to the Right */}
