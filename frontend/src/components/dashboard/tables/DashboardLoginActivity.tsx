          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
            {data.map((row, index) => (
              ...
              >
                ...
                <td className="px-5 py-2">
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      ...
                      {row.isOnline && (
                        <span className="absolute -bottom-0.5 -right-0.5 w-2 h-2 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-slate-900 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" />
                      )}
                    </div>
                ...
                <td className="px-5 py-2 text-slate-500 dark:text-slate-400 text-xs font-medium">
                  {row.loginAt}
                </td>
              </tr>
            ))}
