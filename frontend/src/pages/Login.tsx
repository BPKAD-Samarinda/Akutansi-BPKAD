    ...
    <div className="min-h-screen w-full flex bg-slate-50 relative">
      ...
      {showWelcome && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm bg-slate-950/55 animate-[welcomeBgFade_0.4s_ease-out] pointer-events-auto">
          ...
          `}</style>
          <div className="relative w-full max-w-[320px] bg-white dark:bg-slate-900 rounded-[2rem] p-6 shadow-[0_25px_60px_rgba(0,0,0,0.12)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.5)] border border-slate-100 dark:border-slate-800/80 text-center animate-[welcomeScaleIn_0.5s_cubic-bezier(0.16,1,0.3,1)_both] group overflow-hidden">
            ...
            <div className="mx-auto mb-5 h-16 w-16 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 animate-[welcomePulse_2s_infinite] relative">
            ...
            {/* Status Badge */}
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-bold bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 uppercase tracking-wider mb-3.5 border border-emerald-100 dark:border-emerald-500/20">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-ping" />
              Akses Berhasil Diberikan
            </span>

            {/* Title & Description */}
            <h3 className="text-lg sm:text-xl font-black text-slate-800 dark:text-white leading-tight mb-2">
              Selamat Datang Kembali!
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-[250px] mx-auto mb-5">
