      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8 py-8 lg:py-0 order-2 lg:order-1 animate-[slideInLeft_0.6s_ease-out]">
        <div className="w-full max-w-[460px] bg-white rounded-3xl shadow-2xl shadow-orange-500/10 px-6 sm:px-12 py-10 sm:py-14 border border-orange-100/50 backdrop-blur-sm animate-[fadeIn_0.8s_ease-out_0.2s_both]">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            {/* USERNAME INPUT */}
            <div className="group animate-[slideUp_0.5s_ease-out_0.5s_both]">
              ...
              <div className="relative">
                ...
                <div className="relative flex items-center bg-gray-50 border-2 border-gray-200 rounded-xl px-4 py-3.5 transition-all duration-300 focus-within:border-orange-500 focus-within:bg-white focus-within:shadow-lg focus-within:shadow-orange-500/20 group-hover:border-orange-300">
                  <img
                    src={userIcon}
                    className="w-5 h-5 mr-3 opacity-40 group-focus-within:opacity-70 transition-opacity"
                    alt="User"
                  />
                  <input
                    type="text"
            ...
            {/* PASSWORD INPUT */}
            <div className="group animate-[slideUp_0.5s_ease-out_0.6s_both]">
              <label className="block text-xs font-bold text-gray-700 mb-2.5 tracking-wide uppercase">
                Kata Sandi
              </label>
              <div className="relative">
